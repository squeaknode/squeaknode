...
Revision ID: e446cd96d79f
Revises:
Create Date: 2021-02-05 23:40:28.267282
...
def upgrade():
    ...
    op.create_table('received_offer',
                    sa.Column(
                        'received_offer_id', SLBigInteger(), nullable=False),
                    sa.Column('created', TZDateTime(
                    ), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    ...
    op.create_table('sent_offer',
                    sa.Column(
                        'sent_offer_id', SLBigInteger(), nullable=False),
                    sa.Column('created', TZDateTime(
                    ), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
                    sa.Column('squeak_hash', sa.String(
                        length=64), nullable=False),
    ...
    op.create_table('sent_payment',
                    sa.Column(
                        'sent_payment_id', SLBigInteger(), nullable=False),
                    sa.Column('created', TZDateTime(
                    ), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
                    sa.Column('peer_id', sa.Integer(), nullable=False),
                    sa.Column('squeak_hash', sa.String(
